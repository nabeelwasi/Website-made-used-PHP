...
<html>
<head>
 <title>bechdo | Registration Successfull......</title>
...
<br>
<br>
<h1 class="text-center text-primary"> Registration Successfull</h1>
<h3 class="text-center text-primary">  Thanks for using Bech.do</h3>
<br/>
<p class="text-center text-primary"> You are successfully registered to Bech dyy !! You are authorized user now you can login for using the features we provided </p>
