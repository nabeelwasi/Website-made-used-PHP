...
$resultfree = mysqli_query($mysqli, "SELECT * FROM products where cate='mb'");
?>
<html>
<head>
 <title>bechdo | Mobiles</title>
...
<div class="container">
 <h3 class="text-primary text-left bg-primary">Mobile Phones</h3>
<?php
